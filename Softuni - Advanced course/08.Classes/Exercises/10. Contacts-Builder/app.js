...
let contacts = [
    new Contract("Ivan", "Ivanov", "0888 123 456", "i.ivanov@gmail.com"),
    new Contract("Maria", "Petrova", "0899 987 654", "mar4eto@abv.bg"),
    new Contract("Jordan", "Kirov", "0988 456 789", "jordk@gmail.com"),
];
